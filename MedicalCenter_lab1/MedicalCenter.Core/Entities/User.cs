...
namespace MedicalCenter.Core.Entities
{
    public class User : IdentityUser<Guid>, IEntity<Guid>
    {
        ...
        public virtual ICollection<Diagnosis> DocMedRecord { get; set; } = new HashSet<Diagnosis>();
        public virtual ICollection<Diagnosis> PatMedRecord { get; set; } = new HashSet<Diagnosis>();
